...
app.get('/allChrs', function _callee2(req, res) {
  var chrs;
...
app.get('/randomSelectOne', function _callee3(req, res) {
...
app.get('/getGuarantee4star', function _callee4(req, res) {
...
app.get('/getGuarantee6star', function _callee5(req, res) {
...
app.get('/getGuaranteeRateUp6star', function _callee6(req, res) {
  var returnChr;
...
app.get('/allChrs_2', function _callee7(req, res) {
  var chrs;
...
app.get('/randomSelectOne_2', function _callee8(req, res) {
  var randomNum, randomChr, randomRateUp, randomRateUpChrNumber, randomBoolean;
...
app.get('/getGuarantee4star_2', function _callee9(req, res) {
  var randomNum, randomChr;
...
app.get('/getGuarantee5star_2', function _callee10(req, res) {
  var detector, randomBoolean, randomNum, randomChr;
...
app.get('/getGuaranteeRateUp5star_2', function _callee11(req, res) {
  var returnChr;
