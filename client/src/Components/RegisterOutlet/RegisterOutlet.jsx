...
const RegisterOutlet = () => {
  ...
  return (
    <form className="register-form">
        ...
        <a className={`little-eye ${(eyeState_1 === "enable") ? "" : "hide"}`} onClick={() => {setEyeState_1("disable")}}><FaEye/></a>
        <a className={`little-eye ${(eyeState_1 === "disable") ? "" : "hide"}`} onClick={() => {setEyeState_1("enable")}}><FaEyeSlash/></a>
        <a className={`little-eye-confirm ${(eyeState_2 === "enable") ? "" : "hide"}`} onClick={() => {setEyeState_2("disable")}}><FaEye/></a>
        <a className={`little-eye-confirm ${(eyeState_2 === "disable") ? "" : "hide"}`} onClick={() => {setEyeState_2("enable")}}><FaEyeSlash/></a>
