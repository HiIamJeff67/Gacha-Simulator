...
const LoginOutlet = () => {
  ...
  return (
    <form className="login-form">
        ...
        <a href="#" className={`little-eye ${(eyeState === "enable") ? "" : "hide"}`} onClick={() => {setEyeState("disable")}}><FaEye/></a>
        <a href="#" className={`little-eye ${(eyeState === "disable") ? "" : "hide"}`} onClick={() => {setEyeState("enable")}}><FaEyeSlash/></a>
